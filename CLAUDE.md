# Yonder — Claude Code Instructions

## Start Here

This is an online multiplayer implementation of the Faraway board game, called Yonder.
...
├── yonder-server/       ← Rust WebSocket server
...
- Card images live in `yonder-client/region/` and `yonder-client/sanctuary/`
