...
fn regions() -> Vec<RegionCard> {
    vec![
        ...
        RegionCard { number: 4, biome: Biome::Red, night: false, clue: false, wonders: w(1,1,0), quest: WonderCount::zero(), fame: Fame::None },
        RegionCard { number: 5, biome: Biome::Green, night: false, clue: false, wonders: w(0,1,0), quest: WonderCount::zero(), fame: Fame::None },
        ...
        RegionCard { number: 18, biome: Biome::Green, night: false, clue: false, wonders: w(0,1,0), quest: WonderCount::zero(), fame: Fame::PerWonderSet { score_per: 10 } },
        ...
        RegionCard { number: 40, biome: Biome::Blue, night: true, clue: false, wonders: WonderCount::zero(), quest: w(1,1,1), fame: Fame::PerNight { score_per: 10 } },
        ...
        RegionCard { number: 61, biome: Biome::Green, night: false, clue: false, wonders: WonderCount::zero(), quest: w(0,4,0), fame: Fame::Flat(17) },
