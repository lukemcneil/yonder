...
fn regions() -> Vec<RegionCard> {
    vec![
        ...
        RegionCard {
            ...
            wonders: w(0, 1, 0),
            quest: WonderCount::zero(),
            fame: Fame::PerColourSet { score_per: 10 },
        },
        RegionCard {
            number: 19,
            biome: Biome::Red,
        ...
        RegionCard {
            ...
            wonders: w(0, 0, 1),
            quest: w(2, 1, 0),
            fame: Fame::PerNight { score_per: 4 },
        },
        RegionCard {
            number: 42,
            biome: Biome::Yellow,
...
fn expansion_regions() -> Vec<RegionCard> {
    vec![
        ...
        RegionCard {
            ...
            wonders: WonderCount::zero(),
            quest: WonderCount::zero(),
            fame: Fame::PerWonderSet { score_per: 7 },
        },
        RegionCard {
            number: 70,
            biome: Biome::Colorless,
...
fn expansion_sanctuaries() -> Vec<SanctuaryCard> {
    vec![
        ...
        SanctuaryCard {
            ...
            clue: true,
            wonders: WonderCount::zero(),
            fame: Fame::PerWonderSet { score_per: 3 },
        },
        SanctuaryCard {
            tile: 48,
            biome: Biome::Colorless,
...
fn sanctuaries() -> Vec<SanctuaryCard> {
    vec![
        ...
        SanctuaryCard {
            ...
            clue: false,
            wonders: WonderCount::zero(),
            fame: Fame::PerColourSet { score_per: 4 },
        },
        SanctuaryCard {
            tile: 23,
            biome: Biome::Yellow,
